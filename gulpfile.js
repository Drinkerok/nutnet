...
gulp.task('watch', () => {
  ...
  gulp.watch(Paths.icons.src, gulp.series('sprite', 'server:refresh'));
...
// Build \\
gulp.task('build', gulp.series('clean', gulp.parallel('img:sprite', 'sprite', 'styles', 'img', 'scripts', 'copy'), 'img:webp', 'pug'));
